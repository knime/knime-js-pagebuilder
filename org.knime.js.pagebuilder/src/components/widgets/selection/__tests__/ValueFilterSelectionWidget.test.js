...
describe("ValueFilterSelectionWidget.vue", () => {
    ...
    props = {
      nodeConfig: {
        ...
        viewRepresentation: {
          ...
          defaultValue: {
            "@class":
              "org.knime.js.base.node.base.filter.value.ValueFilterNodeValue",
      ...
      nodeConfig: {
        ...
        viewRepresentation: {
          ...
          possibleValues: {
            ...
            "Other Membership": ["Other 1", "Other 2"],
          },
          type: "List",
          limitNumberVisOptions: false,
          numberVisOptions: 10,
          possibleColumns: ["Cluster Membership", "Other Membership"],
        },
        viewValue: null,
        initMethodName: "init",
        validateMethodName: "validate",
  ...
  it("does not render duplicate entries", () => {
    props.nodeConfig.viewRepresentation.possibleColumns = [
      "1",
      "2",
      "3",
      "3",
