...
} from "@@/test/assets/views/extensionConfig";
        ...
        api: {
          ...
          getters: {
            ...
            uiExtResourceLocation: () => () =>
              "http://localhost:8080/your_resource.html",
          },
          namespaced: true,
        },
      },
  ...
  describe("handling messages", () => {
    ...
    it("displays alerts via extensionConfig", () => {
      ...
      const expectedAlert = {
        ...
        type: "error",
        subtitle: "",
        nodeId: props.extensionConfig.nodeId,
      };
    ...
    it("sets alerts via pagebuilder store", () => {
      ...
      expect(showAlertSpy).toHaveBeenCalledWith({
        ...mockAlert,
        callback: wrapper.vm.closeAlert,
      });
